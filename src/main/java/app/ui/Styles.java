...
public class Styles {
    ...
    public static String bgApp()      { return darkMode ? "#0D0D0F" : "#F2F2F7"; }
    public static String bgPanel()    { return darkMode ? "rgba(28,28,30,0.95)" : "rgba(255,255,255,0.78)"; }
    public static String bgRow()      { return darkMode ? "rgba(255,255,255,0.06)" : "#ECECEF"; }
    public static String bgRowHdr()   { return darkMode ? "rgba(255,255,255,0.10)" : "#D9D9DD"; }
    public static String bgTabBar()   { return darkMode ? "rgba(255,255,255,0.07)" : "#EEF1F5"; }
    public static String borderSoft() { return darkMode ? "rgba(255,255,255,0.12)" : "#E6E9EF"; }
    public static String textMain()   { return darkMode ? "#F5F5F7" : "#1F2937"; }
    public static String textSub()    { return darkMode ? "#8E8E93" : "#6B7280"; }
    ...
    private static String glassSpecular() {
        return darkMode ? "rgba(255,255,255,0.07)" : "rgba(255,255,255,0.28)";
    }
    private static String glassBody() {
        return darkMode ? "rgba(44,44,46,0.88)" : "rgba(255,255,255,0.68)";
    }
    private static String glassShadow() {
        return darkMode
                ? "dropshadow(gaussian,rgba(0,0,0,0.55),22,0.12,0,4)"
                : "dropshadow(gaussian,rgba(0,0,0,0.09),18,0.08,0,3)";
    }
    private static String inputBg() {
        return darkMode ? "rgba(28,28,30,0.8)" : "rgba(255,255,255,0.85)";
    }
    private static String btnBg() {
        return darkMode ? "rgba(60,60,62,0.7)" : "rgba(255,255,255,0.72)";
    }
    private static String btnHoverBg() {
        return darkMode ? "rgba(80,80,82,0.85)" : "rgba(255,255,255,0.92)";
    }
    private static String btnPressedBg() {
        return darkMode ? "rgba(40,40,42,0.9)" : "rgba(220,220,228,0.95)";
    }
    ...
    public static void installComboPopupStyle(ComboBox<?> cb) {
        cb.showingProperty().addListener((o, ov, showing) -> {
            ...
            Platform.runLater(() -> {
                try {
                    String popupBg = darkMode ? "rgba(44,44,46,0.97)" : "#FFFFFF";
